...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    short_desc: Attribute.String & Attribute.Required;
    long_desc: Attribute.Text & Attribute.Required;
    ...
    category: Attribute.Relation<
      ...
      'api::category.category'
    >;
    size: Attribute.Enumeration<['L', 'XL', 'XS']> & Attribute.Required;
    content: Attribute.RichText & Attribute.Required;
    color: Attribute.Enumeration<['VIOLETE', 'BROWN', 'BLACK']> &
      Attribute.Required;
